...
declare namespace GatsbyTypes {
  ...
  type SitePageContext = {
    ...
    readonly identifer: Maybe<Scalars['String']>
  }
  ...
  type SitePageContextFilterInput = {
    ...
    readonly regex: Maybe<StringQueryOperatorInput>
    ...
    readonly identifer: Maybe<StringQueryOperatorInput>
  }
  ...
  enum SitePageFieldsEnum {
    ...
    context___identifer = 'context.identifer',
      ...
      readonly nodes: ReadonlyArray<
        Pick<MarkdownRemark, 'html'> & {
          ...
          readonly frontmatter: Maybe<
            Pick<
              Frontmatter,
              'date' | 'title' | 'description' | 'author' | 'published_date'
            > & {
