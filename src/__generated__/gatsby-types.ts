...
type BlogPostBySlugQuery = { readonly markdownRemark: Maybe<(
    Pick<MarkdownRemark, 'excerpt' | 'id' | 'htmlAst' | 'tableOfContents'>
...
type BioQuery = { readonly avatar: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }>, readonly site: Maybe<{ readonly siteMetadata: Maybe<{ readonly author: Maybe<Pick<Author, 'name'>>, readonly social: Maybe<Pick<Social, 'twitter' | 'github'>> }> }> };

type CatQueryVariables = Exact<{ [key: string]: never; }>;


type CatQuery = { readonly tech: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }>, readonly daily: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> };

type Unnamed_1_QueryVariables = Exact<{ [key: string]: never; }>;


type Unnamed_1_Query = { readonly allImageSharp: { readonly nodes: ReadonlyArray<{ readonly fluid: Maybe<(
...
type SeoQuery = { readonly avatar: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<Pick<ImageSharpFluid, 'src'>> }> }>, readonly site: Maybe<{ readonly siteMetadata: Maybe<(
